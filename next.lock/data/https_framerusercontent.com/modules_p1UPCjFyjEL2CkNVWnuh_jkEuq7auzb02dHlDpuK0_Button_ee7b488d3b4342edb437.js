import{jsx as _jsx}from"react/jsx-runtime";import styled from"@emotion/styled";import{css}from"@emotion/react";import{motion}from"framer-motion";import{addPropertyControls,ControlType}from"framer";import{color,COLOR}from"https://framerusercontent.com/modules/l1WcRLRSnhtvIgBHNKF1/9Z03ka8AHkVvf1q6NmVD/Color.js";import{SIZE,THEME,TYPE}from"https://framerusercontent.com/modules/uc0yHe8XNTh1oRhaYnDm/TLUc7i16QLhLsO7xc344/constants.js";const sizes={[SIZE.BIG]:css`
  ...
  `;};function getStyle(props){const{size,$theme,outlined}=props;return css`
        display: flex;
        align-items: center;
 ...
 */ function Button(props){const{type,theme,label,icon,outlined,disabled,...restProps}=props;console.log(props);return(/*#__PURE__*/ _jsx(StyledButton,{$theme:theme,icon:icon,outlined:outlined,disabled:disabled,...restProps,children:label}));}Button.defaultProps={width:335,type:TYPE.BUTTON,size:SIZE.BIG,outlined:false,theme:THEME.PRIMARY,icon:undefined,disabled:false,label:"버튼 이름"};addPropertyControls(Button,{label:{type:ControlType.String},size:{type:ControlType.Enum,defaultValue:"large",options:["big","large","medium","small","mini","none"]},theme:{type:ControlType.Enum,defaultValue:"primary",options:["primary","secondary","mono","warning","dashed","line","none",]},outlined:{type:ControlType.Boolean},disabled:{type:ControlType.Boolean},onTap:{type:ControlType.EventHandler}});export default Button;
export const __FramerMetadata__ = {"exports":{"default":{"type":"reactComponent","name":"Button","slots":[],"annotations":{"framerSupportedLayoutWidth":"fixed","framerContractVersion":"1","framerSupportedLayoutHeight":"auto"}},"__FramerMetadata__":{"type":"variable"}}}
